...
TimeInterval::TimeInterval(unsigned long interval, unsigned long offset,
                           bool autoUpdate)
    : interval(interval),
...
void TimeInterval::pause() { paused = true; }

void TimeInterval::resume() { paused = false; }

bool TimeInterval::is_paused() { return paused; }